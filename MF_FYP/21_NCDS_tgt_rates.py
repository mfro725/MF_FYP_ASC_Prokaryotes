...
data_columns = ['accession', 'tot_UTRs_non_coding', 'tot_seq_non_coding', 'num_of_tgt_non_coding', 'frequency_tgt_non_coding']
...
with open('21.1_NCDS_tgt_rates.csv', 'w', newline='') as f:
    writer = csv.writer(f)
